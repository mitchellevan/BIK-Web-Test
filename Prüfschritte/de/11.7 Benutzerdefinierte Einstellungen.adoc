...
* Farben und Kontraste (z. B. Darkmode)
* Schriftgrößen
...
* Die Seite wird nach dem Vornehmen von eigenen Farbeinstellungen (z.B. heller Text auf dunklem Hintergrund) richtig dargestellt
* Fließtexte erscheinen nach Vergrößerung der Standard-Schriftgröße in den Browsereinstellungen vergrößert
